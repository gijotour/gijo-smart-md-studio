...
| @turbodocx/html-to-docx | 1.22.0 | `npm pack @turbodocx/html-to-docx@1.22.0` → `package/dist/html-to-docx.browser.js` | MIT | `html-to-docx/html-to-docx.browser.js` (IIFE build, exposes `window.HTMLToDOCX`) + `html-to-docx/polyfills.js` (hand-copied verbatim from the package's own README "Browser Usage" section — must load first) |
